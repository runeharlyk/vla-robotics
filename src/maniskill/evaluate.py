...
def rt1_tf(
    ...
    max_steps: int = typer.Option(100, "--max-steps", "-s", help="Max steps per episode"),
    policy_setup: str = typer.Option(
        "google_robot", "--policy-setup", "-p", help="Policy setup: google_robot or widowx_bridge"
    ),
    save_video: bool = typer.Option(False, "--save-video", help="Save video of episodes"),
    ...
    from maniskill.rt1_tf_policy import RT1TFPolicy
