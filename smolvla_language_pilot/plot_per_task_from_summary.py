"""
Generate per-task relative L2 plots from a pre-computed variant_sweep_summary.json.
...
Usage:
    uv run python -m smolvla_language_pilot.plot_per_task_from_summary \
        --summary smolvla_language_pilot/outputs/variant_sweep_summary.json \
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--summary",
        default="smolvla_language_pilot/outputs/variant_sweep_summary.json",
        help="Path to variant_sweep_summary.json produced by multitask_diagnostic.py.",
    )
    parser.add_argument(
        "--output-dir",
